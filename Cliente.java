...
public class Cliente {
	private String nome;														//Declaraçao dos atributos
	private Cpf cpf;
	private float renda;
	private int idade;
	private int sexo;
	...
	public String getPrimeiroNome(){											//Metodo para receber o valor do atributo
		...
		String primeiroNome = nome.substring(0,indice);							//Recebe a cadeia de caracteres da posiçao inicial até a final, ambas dadas
	...
	public String getUltimoNome(){												//Metodo para receber o valor do atributo
		...
		String ultimoNome = nome.substring(indice+1);							//Recebe a cadeia de caracteres da posiçao inicial até a final da cadeia de caracteres
	...
	public boolean equals(Cliente aux){											//Metodo para comparar cpf entre dois clientes
		return cpf.equals(aux.cpf.getCPF());
		
	}
	
	public String toString(){													//Metodo que altera para o tipo cadeia de caracteres
